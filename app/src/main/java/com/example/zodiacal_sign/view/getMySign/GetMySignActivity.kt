...
class GetMySignActivity : AppCompatActivity() {
    ...
    private fun getSign(day: Int, month: Int): String {
        ...
        if (month == 1 && day > 20) return "Eres acuario"
        if (month == 2 && day <= 18) return "Eres acuario"
        if (month == 2 && day > 18) return "Eres piscis"
        if (month == 3 && day <= 20) return "Eres piscis"
        if (month == 3 && day > 20) return "Eres aries"
        if (month == 4 && day <= 19) return "Eres aries"
        if (month == 4 && day > 19) return "Eres tauro"
        if (month == 5 && day <= 20) return "Eres tauro"
        if (month == 5 && day > 20) return "Eres geminis"
        if (month == 6 && day <= 20) return "Eres geminis"
        if (month == 6 && day > 20) return "Eres cancer"
        if (month == 7 && day <= 22) return "Eres cancer"
        if (month == 7 && day > 22) return "Eres leo"
        if (month == 8 && day <= 22) return "Eres leo"
        if (month == 8 && day > 22) return "Eres virgo"
        if (month == 9 && day <= 22) return "Eres virgo"
        if (month == 9 && day > 22) return "Eres libra"
        if (month == 10 && day <= 22) return "Eres libra"
        if (month == 10 && day > 22) return "Eres escorpio"
        if (month == 11 && day <= 21) return "Eres escorpio"
        if (month == 11 && day > 21) return "Eres sagitario"
        if (month == 12 && day <= 21) return "Eres sagitario"
